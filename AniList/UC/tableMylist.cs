...
{
    public partial class tableMylist : UserControl
    {
        ...
        string sortby = null;
        string Q, User=null;
        public tableMylist(string q = null, string user=null)
        {
            Q = q; User= user;
            InitializeComponent();
        }
        ...
        void Display()
        {
            ...
            foreach (Youranime z in final)
            {
                ...
                flowLayoutPanel1.Controls.Add(ani);
            }
        }
