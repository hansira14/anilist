...
{
    public partial class tableRank : UserControl
    {
        public tableRank(int x, string z, int count = 0)
        {
            InitializeComponent();
            retrieve.LoadTrendingAnime(tablee, x, count, 1);
            list.Text = z;
        }
